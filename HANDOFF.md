...
- **(A) 添削表示の「文字びっしり/圧迫感」改善（未着手・最優先）**: ゆかたんから「画面一面にボワーっと出て読みたくなくなる」。**折りたたみ式**で合意間際＝最初は「点数・まず最初の一手・次回こうしよう3つ」だけ大きく表示し、「項目別の出来」「次回までに確認したいこと」は「▶ 詳しく見る」で開く形に。対象: public/index.html（renderMarkdown / #output 周辺・約2029行）。
